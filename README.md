...
*[NTD: to edit] Accordingly, this safe shore proposal (the Proposal) is intended to provide an Initial Development Teams with a three-year time period within which they can facilitate participation in, and the continued development of, a blockchain-related network, exempt from certain provisions of the provincial securities laws so long as certain conditions are met.  The safe shore is designed to protect secondary Token purchasers by requiring disclosures tailored to the needs of the purchasers and preserving the potential application of the anti-fraud provisions of the provincial securities laws to statements and disclosures made regarding the Token by an Initial Development Team.*
