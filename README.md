...
1.  *The analysis of whether a digital asset is offered or sold as a security is not static and does not strictly inhere to the digital asset.  While a Token may be offered and sold as a security because it is wrapped in a transaction involving an investment contract, Tokens may alao be issued solely in exchange for effort expended or actions taken within a network, such as when a miner on the Bitcoin network is successful in identifying the nonce required to satisfy the algorithm, after which the miner propogates a new block to the network and is rewarded in the form of newly created bitcoin. This bitcoin was created outside of an investment contract and does not need to "morph" into or out of a security. For example, issuance of a particular Token in a manner that is not a sale could not constitute "sales" of an investment contract as there are no "purchasers", there is no "common enterprise" - just a group of individuals holding a similar asset (analogous to every engineer given a steel ring alongside their with a steel ring being considered in a common enterprise) could no longer reasonably expect a person or group to carry out the essential managerial or entrepreneurial efforts.*
